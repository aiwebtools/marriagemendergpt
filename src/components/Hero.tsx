...
const Hero = () => {
  ...
  return <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden section-padding pt-16">
      {/* Divine Background Effects */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-rustic-accent/30 to-yellow-400/30 rounded-full filter blur-3xl animate-holy-float" style={{
        animationDelay: "0s"
      }}></div>
        <div className="absolute bottom-1/3 right-1/3 w-80 h-80 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full filter blur-3xl animate-holy-float" style={{
        animationDelay: "2s"
      }}></div>
        ...
        <div className="absolute top-20 right-20 w-32 h-32 bg-gradient-to-r from-yellow-400/40 to-orange-400/40 rounded-full filter blur-2xl animate-holy-float" style={{
        animationDelay: "1s"
      }}></div>
        <div className="absolute bottom-20 left-20 w-48 h-48 bg-gradient-to-r from-purple-400/30 to-pink-400/30 rounded-full filter blur-3xl animate-holy-float" style={{
        animationDelay: "3s"
      }}></div>
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
        <Star className="absolute top-32 left-32 h-6 w-6 text-yellow-400 animate-divine-pulse" style={{
        animationDelay: "0s"
      }} />
        <Star className="absolute top-48 right-48 h-4 w-4 text-rustic-accent animate-divine-pulse" style={{
        animationDelay: "1s"
      }} />
        <Star className="absolute bottom-48 left-48 h-5 w-5 text-blue-400 animate-divine-pulse" style={{
        animationDelay: "2s"
      }} />
        <Star className="absolute bottom-32 right-32 h-7 w-7 text-purple-400 animate-divine-pulse" style={{
        animationDelay: "3s"
      }} />
        <Sparkles className="absolute top-40 left-1/4 h-5 w-5 text-yellow-300 animate-divine-pulse" style={{
        animationDelay: "0.5s"
      }} />
        <Sparkles className="absolute bottom-40 right-1/4 h-4 w-4 text-orange-400 animate-divine-pulse" style={{
        animationDelay: "2.5s"
      }} />
      </div>
      ...
      <div className="container mx-auto z-20 relative">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          <div className="lg:w-full space-y-8 animate-fade-in-slow text-center lg:text-left">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold text-transparent bg-gradient-to-r from-white via-rustic-accent to-yellow-400 bg-clip-text mb-4">Marriage Mender GPT by AI Web Tools </h2>
            ...
            <div className="flex flex-wrap gap-6 pt-6">
              <ButtonCustom variant="accent" size="lg" className="group relative overflow-hidden px-10 py-4 text-lg font-bold transform hover:scale-110 transition-all duration-500 divine-glow" onClick={() => window.open("https://chatgpt.com/g/g-0MogI8wIQ-marriage-mender-gpt", "_blank")}>
              ...
              <ButtonCustom variant="outline" size="lg" className="px-8 py-4 text-lg backdrop-blur-lg bg-white/5 border-2 border-white/20 hover:border-rustic-accent/50 hover:bg-white/10 transform hover:scale-105 transition-all duration-300" onClick={() => document.getElementById("how-it-works")?.scrollIntoView({
              behavior: "smooth"
            })}>
            ...
            <div className="w-full max-w-4xl mx-auto mb-8 z-30 relative">
              <div className="relative w-full">
                <div className="relative w-full bg-black rounded-2xl overflow-hidden shadow-2xl border-2 border-white/30" style={{
                aspectRatio: '16/9'
              }}>
                  <iframe src="https://www.youtube.com/embed/3HCv5_QldrU?controls=1&rel=0&modestbranding=1&playsinline=1&autoplay=0&mute=0" title="Marriage Mender GPT Introduction - AI Web Tools for Relationship Healing" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen className="absolute inset-0 w-full h-full" style={{
                  border: 'none',
                  display: 'block'
                }} />
                </div>
